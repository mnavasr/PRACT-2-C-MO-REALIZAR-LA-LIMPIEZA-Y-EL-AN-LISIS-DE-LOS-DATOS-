# M2.851_PRACT2 - GENERACIÓN DE DATASETS HISTÓRICOS PARA ENRIQUECIMIENTO
...
# Rutas base a los archivos obtenidos de la sección estadóstica de AENA:
ruta_base <- "CSV_LLEGADAS_VLC"
ruta_comp <- file.path(ruta_base, "COMP")
ruta_orgn <- file.path(ruta_base, "ORGN")
ruta_mapping <- "MAPPING"
...
write_csv(PAX_Aerolinea_Historico, file.path(ruta_base, "PAX_Aerolinea_Historico_Final.csv"))
write_csv(PAX_Origen_Historico, file.path(ruta_base, "PAX_Origen_Historico_Final.csv"))
